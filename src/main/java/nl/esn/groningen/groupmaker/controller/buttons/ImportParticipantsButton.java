...
import nl.esn.groningen.groupmaker.controller.actions.ImportParticipantsAction;
 ...
 * @see GroupingModel
 */
public class ImportParticipantsButton extends Button {
     ...
     */
    public ImportParticipantsButton(GroupingModel groupingModel, String tooltip) {
        super(new ImportParticipantsAction(groupingModel), tooltip);
    }
}
